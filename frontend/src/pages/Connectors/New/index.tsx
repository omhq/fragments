...
import { IConnectorCreatePayload } from "../../../types";
import { checkHttpStatus } from "../../../utils/api/helpers";
import { connectorHttpCreate } from "../../../utils/api/connectors";
import { connectorCreated } from "../../../reducers/main";
...
interface IConnectorNewProps {
  state: any;
  dispatch: any;
}

const ConnectorNew = (props: IConnectorNewProps) => {
  ...
  const onCreate = (payload: IConnectorCreatePayload) => {
    setCreating(true);
    connectorHttpCreate(payload)
      .then(checkHttpStatus)
      .then(data => {
        dispatch(connectorCreated(data));
            ...
            <div className="text-center sm:text-left">
              <div className={`max-h-96 overflow-y-auto`}>
                <CodeEditor
                  ...
                  language={"python"}
                  onChange={(e: any) => {
                    formik.setFieldValue("data", e, false);
                  }}
                  disabled={false}
                  lineWrapping={false}
                />
